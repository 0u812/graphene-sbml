angular.module('sg.graphene.sbml.templates', ['templates/context-menus.html', 'templates/sbml.html', 'templates/svg.html', 'templates/toolbar.html']);
...
angular.module('templates/svg.html', []).run(['$templateCache', function($templateCache) {
  'use strict';
  $templateCache.put('templates/svg.html',
    '<svg\n' +
    '  zoomable="AppState.zoom"\n' +
    '  xmlns="http://www.w3.org/2000/svg"\n' +
    '  ng-attr-height="{{imports.height || \'800px\'}}"\n' +
